...
from exllamav2 import ExLlamaV2, ExLlamaV2Config, ExLlamaV2Cache, ExLlamaV2Cache_Q4, ExLlamaV2Tokenizer, Timer
...
cache = ExLlamaV2Cache_Q4(model, max_seq_len = 12800, lazy = True)
